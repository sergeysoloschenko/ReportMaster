...
38 автоматических тестов, включая синтетический цикл от EWS до утверждения DOCX/ZIP; production-сборка Vite. Реальная ChatGPT-авторизация SDK и доступность Luna/Terra подтверждены. Luna проверена на четырёх синтетических письмах; исходный июльский DOCX разобран Terra. Чтение реального ящика и отчёт за август требуют настройки секрета Exchange и проверки исходного черновика.
